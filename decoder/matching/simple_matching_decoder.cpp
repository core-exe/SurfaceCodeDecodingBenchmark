...
StandardMWPMDecoder::StandardMWPMDecoder(
    ...
    double pm,
    bool measurement_error,
    ErrorDynamics::CodeScheme::RectShape _shape) : StandardMWPMDecoder::SimpleMatchingDecoder(px, py, pz, pm, measurement_error, _shape) {}

StandardMWPMDecoder::StandardMWPMDecoder(
    double p,
    bool measurement_error,
    ErrorDynamics::CodeScheme::RectShape _shape) : StandardMWPMDecoder::SimpleMatchingDecoder(p, measurement_error, _shape) {}

std::pair<bool, double> StandardMWPMDecoder::distance_function(RectIndex3d idx_a, RectIndex3d idx_b) {
...
std::pair<bool, double> StandardMWPMDecoder::edge_distance_function_space(RectIndex3d idx) {
...
std::pair<bool, double> StandardMWPMDecoder::edge_distance_function_time(RectIndex3d idx, int t_total) {
